VERSION 5.00
Begin VB.Form IteratorFrmAbout 
   ...
   Icon            =   "IteratorFrmAbout.frx":0000
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.Label Label1 
      Caption         =   $"IteratorFrmAbout.frx":0442
      Height          =   615
      Left            =   120
      TabIndex        =   2
      Top             =   480
   ...
   End
End
Attribute VB_Name = "IteratorFrmAbout"
...
Private Sub Form_Load()
 ...
 lblTitle.Caption = "Daisy 2.02 DTB Validator Iterator"
